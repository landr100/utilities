...
# usage:
# hex.py --from={hex|oct|dec|bin} --to={hex|oct|dec|bin} NNNN
# for example:
# hex.py --from dec --to bin 15 # should output 1111
...
# re-implemented a previous version that was written in ruby
